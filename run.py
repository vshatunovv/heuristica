...
from src.randomized import randomized_construct, local_search_swap
from src.evaluate import evaluate

def solve_instance(inst_dir: str, plantilla: str, out_dir: str, seed: int = 42):
    random.seed(seed)
    ...
    rnd_assign = local_search_swap(rnd_assign, days, iters=100)
...
def main():
    ...
    ap.add_argument("--instance_dir", required=True, help="carpeta con subcarpetas de instancias")
    ap.add_argument("--plantilla", required=True, help="ruta al archivo Plantilla.xlsx base")
